...
export const chat = action({
	...
	handler: async (ctx, args) => {
        ...
        //when the key is working uncomments the above code and uncomment the below code

		await ctx.runMutation(api.messages.sendChatGPTMessage, {
			// content: messageContent ?? "I'm sorry, I don't have a response for that",
            content : "This message is returned as a response from the OpenAI API because the OPENAI key has got expired",
